...
views_patterns = [
    ...
    path('teacher/<int:teacher_id>/student/assign/', assign_stud_to_teach, name='assign_student_to_teacher'),
    path('teacher/<int:teacher_id>/student/reject/', reject_stud_to_teach, name='reject_student_to_teacher'),
    # students
